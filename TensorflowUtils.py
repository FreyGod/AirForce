...
def save_image(image, save_dir, name, mean=None):
    ...
    resize_image = misc.imresize(image,[initial_size[0], initial_size[1]], interp='nearest')
    misc.imsave(os.path.join(save_dir, name + ".png"), resize_image)


def get_variable(weights, name):
    init = tf.constant_initializer(weights/10.0, dtype=tf.float32)
